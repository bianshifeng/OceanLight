...
//    response.setHeader("Content-Type", "image/jpeg");
    ...
    Template t= g_templateCache->getTemplate("index",request.getHeader("Accept-Language"));
    t.enableWarnings();
...
//    </head>
    ...
    t_body.append("<html><body> <img src=\"Schmetterling klein.png\"> /Try one of the following examples:<p><ul><li><a href=\"/dump\">Dump HTTP request</a><li><a href=\"/template\">Dynamic website using a template engine</a><li><a href=\"/form\">HTML form</a><li><a href=\"/file\">File upload form</a><li><a href=\"/session\">Session demo</a></ul></body></html>");
    response.write(t_body,true);
