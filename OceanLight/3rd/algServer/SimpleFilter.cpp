...
{
    qDebug()<<"11111111111111111111111111111111111111111111111";
    QtAV::VideoFilterContext *ctx = static_cast<QtAV::VideoFilterContext*>(context());
    if (!mText.isEmpty()) {
...
void SimpleFilter::timerEvent(QTimerEvent *)
{
    ...
    {
        ((QQuickItem*)parent())->update();
    }
}

void SimpleFilter::process(QtAV::Statistics *statistics, QtAV::VideoFrame *frame)
{
